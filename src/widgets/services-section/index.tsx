import { component$, useSignal, useOnWindow, $,useOn } from "@builder.io/qwik";
//  useVisibleTask$
...
//  const [cardVisible_02, setCardVisible_02] = useSignal(false);
   const handleResize = $((width: number) => {
   
    if (width >= 820) {
      cardVisible_02.value = true;
      
      //  console.log(cardVisible_02);
  ...
  //     // servicesCardsWrp?.addEventListener('click', () => {
  //     //   console.log(servicesCardsWrp)
  //     //  const cardMap = servicesCardsWrp.map(el => {
          ...
          >
            ...
            <div class="xl:border__left lg:basis-1/2 xl:pl-[50px] ">
              ...
              <div class=" group/card pointer-events-none pb-[18px] pt-[38px] lg:grid lg:grid-flow-row lg:auto-rows-max lg:pb-[30px] lg:pt-[30px] xl:mt-[68px] xl:pb-[64px] xl:pt-0">
                ...
                <button
                 ...
                 onClick$={() => (cardVisible.value = !cardVisible.value)}
                  class="w-full lg:border__bottom pointer-events-none relative block lg:pointer-events-auto xl:border-b-0"
                >
                  <h3 class="text-left border__bottom text__hover-red xl:translate-underline__hover-line__white pointer-events-auto mb-0 pb-[17px] pr-[50px] text-[19px] font-bold uppercase sm:text-[24px] lg:border-b-0 lg:pb-[27px] lg:capitalize xl:pb-[40px] 2xl:text-[42px] 2xl:leading-[50px]">
                ...
                {cardVisible.value && (
                <>
                <div class=" xl:border__top pointer-events-none  lg:pr-[30px] xl:flex xl:flex-col xl:justify-center xl:pr-[50px]">
              ...
              <div class=" group/card pointer-events-none pt-[20px] lg:grid lg:grid-flow-row lg:auto-rows-max lg:py-[30px] xl:py-0">
                ...
                <button
                  id="card-02"
                  onClick$={() => (cardVisible_02.value = !cardVisible_02.value)}
                  // onClick={() => setCardVisible_02(!cardVisible_02)}                
                  class=" is-active w-full  lg:border__bottom group pointer-events-none relative lg:pointer-events-auto xl:border-b-0"
                >
                  <h3 class="text-left  border__bottom text__hover-red xl:translate-underline__hover-line__white pointer-events-auto mb-0 pb-[17px] pr-[50px] text-[19px] font-bold uppercase sm:text-[24px] lg:border-b-0 lg:pb-[27px] lg:normal-case xl:pb-[40px] 2xl:text-[42px] 2xl:leading-[50px]">
                ...
                <> 
                <div class=" lg:block  xl:border__top pointer-events-none mb-[19px]   lg:pr-[30px] xl:flex xl:flex-col xl:justify-center xl:pr-[50px]">
              ...
              <div class=" group/card pointer-events-none pt-[19px] lg:grid lg:grid-flow-row lg:auto-rows-max lg:pb-[30px] lg:pt-[30px] xl:pb-[30px] xl:pt-[61px]">
               {/* block */}
                <button
                  ...
                  class="is-active  w-full lg:border__bottom group pointer-events-none relative  lg:pointer-events-auto xl:border-b-0"
                >
                  <h3 class="text-left border__bottom text__hover-red xl:translate-underline__hover-line__white pointer-events-auto mb-0 pb-[17px] pr-[50px] text-[19px] font-bold uppercase sm:text-[24px] lg:border-b-0 lg:pb-[27px] xl:pb-[40px] 2xl:text-[42px] 2xl:leading-[50px]">
                    SEO
                  </h3>
                ...
                {/* <!-- paragraph-03 --> */}
                  {cardVisible_02.value && (
                <>
                <div class=" xl:border__top pointer-events-none mb-[19px]   lg:pr-[30px] xl:flex xl:flex-col xl:justify-center xl:pr-[50px]">
                  <p class=" pb-10 pt-5 text-base font-medium leading-[22px] text-dark dark:text-white lg:pt-[31px] xl:max-w-[530px] xl:pt-[40px] xl:leading-[150%]">
              ...
              <div class=" group/card pointer-events-none pt-[19px] lg:grid lg:grid-flow-row lg:auto-rows-max lg:py-[30px] xl:pt-[16px]">
                ...
                <button
                  ...
                  class="is-active  w-full lg:border__bottom group pointer-events-none relative  lg:pointer-events-auto xl:border-b-0"
                >
                  <h3 class="text-left  border__bottom text__hover-red xl:translate-underline__hover-line__white pointer-events-auto mb-0 pb-[17px] pr-[50px] text-[19px] font-bold uppercase sm:text-[24px] lg:border-b-0 lg:pb-[27px] lg:capitalize xl:pb-[40px] xl:pt-[12px] 2xl:text-[42px] 2xl:leading-[150%]">
                    Mobile Promotion
                  </h3>
                  <div class="absolute right-[0px] top-[calc(50%-17px)] mt-[-14px] rounded-full p-[13.5px] transition-all ease-in group-hover/card:bg-main lg:right-[10px] lg:top-0 lg:mt-[-16px] lg:p-[23px] xl:right-[10px] xl:top-[-6px] xl:p-[26px] 2xl:top-[-8px] 2xl:p-8">
                    <svg
                ...
                <>
                <div class=" xl:border__top pointer-events-none mb-[19px]  lg:pr-[30px] xl:flex xl:flex-col xl:justify-center xl:pr-[50px]">
                  <p class=" pb-10 pt-5 text-base font-medium leading-[22px] text-dark dark:text-white lg:pt-[31px] xl:max-w-[530px] xl:pt-[40px] xl:leading-[1.5]">
              ...
              <div class=" group/card pointer-events-none pt-[19px] lg:grid lg:grid-flow-row lg:auto-rows-max lg:pb-0 lg:pt-[30px]">
                <button
                  id="card-05"
                   onClick$={() => (cardVisible_02.value = !cardVisible_02.value)}
                  class="is-active  w-full lg:border__bottom group pointer-events-none relative block lg:pointer-events-auto xl:border-b-0"
                >
                  <h3 class="text-left border__bottom text__hover-red xl:translate-underline__hover-line__white pointer-events-auto mb-0 pb-[17px] pr-[50px] text-[19px] font-bold uppercase sm:text-[24px] lg:border-b-0 lg:pb-[27px] xl:pb-[40px] 2xl:text-[42px] 2xl:leading-[50px]">
                ...
                <>
                <div class=" xl:border__top pointer-events-none mb-[19px]   lg:pr-[30px] xl:flex xl:flex-col xl:justify-center xl:pr-[50px]">
                  <p class=" pb-10 pt-5 text-base font-medium leading-[140%] text-dark dark:text-white lg:pb-0 lg:pt-[31px] xl:max-w-[530px] xl:pb-[28px] xl:pt-[40px] xl:leading-[1.5]">
            ...
            <div class="lg:basis-1/2 ">
              ...
              <div class=" group/card lg:border__left pointer-events-none pt-[19px] lg:mt-[71px] lg:grid lg:grid-flow-row lg:auto-rows-max lg:pt-[42px] xl:pt-[170px]">
               {/* href="https://dev.uwp.digital/en/services/digital-marketing"
                ...
                <button
                  id="card-06"
                  onClick$={() => (cardVisible_02.value = !cardVisible_02.value)}
                  class=" is-active w-full lg:border__bottom group pointer-events-none relative block lg:pointer-events-auto"
                >
                  <h3 class=" text-left border__bottom text__hover-red xl:translate-underline__hover-line__white pointer-events-auto mb-0 pb-[17px] pr-[50px] text-[19px] font-bold uppercase sm:text-[24px] lg:border-b-0 lg:pb-[27px] lg:pl-[29px] lg:capitalize xl:pb-[40px] xl:pl-[50px] 2xl:text-[42px] 2xl:leading-[50px]">
                    Digital Marketing
                  </h3>
                ...
                {cardVisible_02.value && (
                <>
                <div class="pointer-events-none mb-[19px] lg:mb-0  lg:pl-[29px] xl:flex xl:flex-col xl:justify-center xl:pl-[50px]">
                  <p class=" pb-10 pt-5 text-base font-medium leading-[22px] text-dark dark:text-white lg:pt-[31px] xl:pt-[40px] xl:leading-[1.5]">
              ...
              <div class=" group/card lg:border__left pointer-events-none pt-[19px] lg:grid lg:grid-flow-row lg:auto-rows-max lg:py-[30px] xl:pt-[24px]">
                ...
                <button
                  ...
                  class="is-active  w-full lg:border__bottom group pointer-events-none relative block lg:pointer-events-auto"
                >
                  <h3 class="text-left  border__bottom text__hover-red xl:translate-underline__hover-line__white pointer-events-auto mb-0 pb-[17px] pr-[50px] text-[19px] font-bold uppercase sm:text-[24px] lg:border-b-0 lg:pb-[27px] lg:pl-[29px] lg:normal-case xl:pb-[40px] xl:pl-[50px] 2xl:text-[42px] 2xl:leading-[50px]">
                    Video motion
                  </h3>
               ...
               {cardVisible_02.value && (
                <>
                <div class=" pointer-events-none mb-[19px]  lg:pl-[29px] xl:flex xl:flex-col xl:justify-center xl:pl-[50px]">
                  <p class=" pb-10 pt-5 text-base font-medium leading-[22px] text-dark dark:text-white lg:pt-[31px] xl:max-w-[555px] xl:pt-[40px] xl:leading-[1.5]">
              ...
              <div class=" group/card lg:border__left pointer-events-none pt-[19px] lg:grid lg:grid-flow-row lg:auto-rows-max lg:py-[30px]">
                ...
                <button
                  ...
                  class="is-active  w-full lg:border__bottom group pointer-events-none relative block lg:pointer-events-auto"
                >
                  <h3 class="text-left  border__bottom text__hover-red xl:translate-underline__hover-line__white pointer-events-auto mb-0 pb-[17px] pr-[50px] text-[19px] font-bold uppercase sm:text-[24px] lg:border-b-0 lg:pb-[27px] lg:pl-[29px] xl:pb-[40px] xl:pl-[50px] 2xl:text-[42px] 2xl:leading-[50px]">
                    SMM
                  </h3>
              ...
              <div class=" group/card lg:border__left pointer-events-none pt-[19px] lg:grid lg:grid-flow-row lg:auto-rows-max lg:pb-[513px] lg:pt-[30px] xl:pt-[69px]">
                ...
                <button
                 ...
                 onClick$={() => (cardVisible_02.value = !cardVisible_02.value)}
                  class="is-active  w-full lg:border__bottom group pointer-events-none relative block lg:pointer-events-auto"
                >
                  <h3 class="text-left  border__bottom text__hover-red xl:translate-underline__hover-line__white pointer-events-auto mb-0 pb-[17px] pr-[50px] text-[19px] font-bold uppercase sm:text-[24px] lg:border-b-0 lg:pb-[27px] lg:pl-[29px] lg:capitalize xl:pb-[40px] xl:pl-[50px] xl:pt-[8px] 2xl:text-[42px] 2xl:leading-[50px]">
                    TikTok
                  </h3>
